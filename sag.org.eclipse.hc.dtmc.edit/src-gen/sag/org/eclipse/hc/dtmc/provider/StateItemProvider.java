...
/**
 * This is the item provider adapter for a {@link sag.org.eclipse.hc.dtmc.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends BaseItemProvider {
	/**
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_label_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_label_feature", "_UI_State_type"),
						DtmcPackage.Literals.STATE__LABEL, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DtmcPackage.Literals.STATE__TRANSITIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case DtmcPackage.STATE__LABEL:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case DtmcPackage.STATE__TRANSITIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DtmcPackage.Literals.STATE__TRANSITIONS,
