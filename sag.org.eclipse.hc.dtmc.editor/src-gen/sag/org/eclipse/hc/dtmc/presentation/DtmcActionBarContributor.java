 ...
 * @generated
 */
public class DtmcActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	...
	protected IAction showPropertiesViewAction = new Action(
			DtmcEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			DtmcEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(DtmcEditorPlugin.INSTANCE.getString("_UI_DtmcEditor_menu"),
				"sag.org.eclipse.hc.dtmcMenuID");
